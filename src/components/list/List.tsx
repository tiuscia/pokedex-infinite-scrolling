...
const PokemonList: React.FC = () => {
  const { setScrollPosition } = useContext(GlobalContext);
  ...
  return (
    <>
      ...
      {allPokemon.length > 0 && (
        <ul 
          className='p-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-screen-sm mx-auto md:p-7 md:max-w-screen-md lg:p-8 lg:max-w-screen-lg'
          >
